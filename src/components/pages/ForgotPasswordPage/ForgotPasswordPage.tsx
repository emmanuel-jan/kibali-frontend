          ...
          <Col className="inherit-height" xs={20} sm={20} md={12} lg={12}>
            <Row justify="center" className="center-div">
              <Col xs={24} sm={24} md={18} lg={18}>
                <Title style={{textAlign:"center"}} level={2} type="secondary">
                  Forgot Password?
                </Title>
                <Title level={5} style={{textAlign:"center"}} type="secondary">We can help with that, all we need is your email address</Title>
                <Form
                  name="normal_login"
                ...
                >
                  ...
                  <Form.Item>
                    ...
                    <Link to="/login" style={{ color: "#8B008B" }} className="login-form-forgot">
                      Login Here
                    </Link>
                  </Form.Item>
                </Form>
