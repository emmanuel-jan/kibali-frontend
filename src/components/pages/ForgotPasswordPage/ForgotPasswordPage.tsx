          ...
          <Col className="inherit-height" xs={20} sm={20} md={12} lg={12}>
            <Row justify="center" className="center-div">
              <Col xs={24} sm={24} md={18} lg={18}>
                <Title style={{textAlign:"center", margin:0,padding:0}} level={4} type="secondary">
                  Forgot Password?
                </Title>
                <Title level={5} style={{textAlign:"center", margin:0, padding:"10px"}} type="secondary">We can help with that, all we need is your email address</Title>
                <Form
                  name="normal_login"
                ...
                >
                  ...
                  <Form.Item style={{textAlign:"center"}}>
                    Or&nbsp;<Link to="/login" style={{ color: "#8B008B" }}>
                        Log in
                    </Link>
                  </Form.Item>
                  <hr />
